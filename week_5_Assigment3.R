...
# Note that the variable "spam" is the dependent variable and 
# is not the frequency of a word stem.
...
# How many variables are labeled as significant (at the p=0.05 level)
# in the logistic regression summary output?
summary(spamLog)

#How many of the word stems "enron", "hou", "vinc", and "kaminski" appear in the CART tree?
prp(spamCART, tweak=1.9)
